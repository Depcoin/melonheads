...
COIN_REPO='https://github.com/Depcoin/melonheads/releases/download/linux2/linux.zip'
...
function compile_node() {
  ...
  gzip -d $COIN_ZIP --strip=2 ${COIN_DIR}/bin/${COIN_BIN_NAME,,}d ${COIN_DIR}/bin/${COIN_BIN_NAME,,}-cli>/dev/null 2>&1
  compile_error
